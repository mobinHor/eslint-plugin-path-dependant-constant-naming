...
const {uppercaseFirstLetter , convertPhraseToSnakeCase } = require("../utils/phraseConvertors");
    ...
    create(context) {
        return {
            ...
            VariableDeclarator: (node) => {
                ...
                const root = (context.options.length && context.options[0].rootDir)
                ...
                if(rootIndex !== -1){
                    ...
                    const snakeCasePrefix = prefixSegments.map( (seg) => convertPhraseToSnakeCase(seg)).join('_')
